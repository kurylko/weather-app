export function getUvAlert({uVIndex}) {
    ...
    if (uVIndex <= 2) {
        ...
        alertMessage = 'Seek shade, wear protective clothing and sunglasses. Avoid being outdoors during midday hours. Use sunscreen with SPF 30+ or higher and reapply every two hours';
    } else {
        uVlevel = 'Extreme high UV-index';
        alertMessage = 'Wear a wide-brimmed hat, sunglasses, and protective clothing. Avoid outdoor activities during peak UV hours. Apply sunscreen with SPF 50+ every two hours.';
    }
